...
main(int argc, char **argv)
{
  ...
  4c:	7c858593          	add	a1,a1,1992 # 810 <malloc+0xe6>
  50:	4509                	li	a0,2
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3f2:	49a50513          	add	a0,a0,1178 # 888 <digits>
 3f6:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 4f6:	33e70713          	add	a4,a4,830 # 830 <malloc+0x106>
 ...
 580:	30cb8b93          	add	s7,s7,780 # 888 <digits>
 ...
 5d4:	25890913          	add	s2,s2,600 # 828 <malloc+0xfe>
        while(*s != 0){
...
malloc(uint nbytes)
{
 ...
 77a:	88a90913          	add	s2,s2,-1910 # 1000 <freep>
  if(p == (char*)-1)
 77e:	5afd                	li	s5,-1
 780:	a895                	j	7f4 <malloc+0xca>
    base.s.ptr = freep = prevp = &base;
 782:	00001797          	auipc	a5,0x1
 786:	88e78793          	add	a5,a5,-1906 # 1010 <base>
