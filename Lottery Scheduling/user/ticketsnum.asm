...
{ 
  ...
  56:	7be58593          	add	a1,a1,1982 # 810 <malloc+0xec>
  5a:	4509                	li	a0,2
  5c:	00000097          	auipc	ra,0x0
  60:	5e2080e7          	jalr	1506(ra) # 63e <fprintf>
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3ec:	4a050513          	add	a0,a0,1184 # 888 <digits>
 3f0:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 4f0:	34470713          	add	a4,a4,836 # 830 <malloc+0x10c>
 ...
 57a:	312b8b93          	add	s7,s7,786 # 888 <digits>
 ...
 5ce:	25e90913          	add	s2,s2,606 # 828 <malloc+0x104>
        while(*s != 0){
...
malloc(uint nbytes)
{
 ...
 780:	c9478793          	add	a5,a5,-876 # 1410 <base>
 ...
 7fe:	b7a080e7          	jalr	-1158(ra) # 374 <sbrk>
  if(p == (char*)-1)
