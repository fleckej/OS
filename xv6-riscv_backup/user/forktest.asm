...
forktest(void)
{
  ...
  3e:	41650513          	add	a0,a0,1046 # 450 <getfilenum+0xc>
  ...
  68:	3fc50513          	add	a0,a0,1020 # 460 <getfilenum+0x1c>
  ...
  b8:	3fc50513          	add	a0,a0,1020 # 4b0 <getfilenum+0x6c>
  ...
  d4:	3b050513          	add	a0,a0,944 # 480 <getfilenum+0x3c>
  ...
  ee:	3ae50513          	add	a0,a0,942 # 498 <getfilenum+0x54>
